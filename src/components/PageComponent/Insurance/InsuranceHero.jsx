...
import CheckGreen from "../../../assets/images/home/Leap_hero/check_simple.svg";
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1280px] flex-col md:gap-12 gap-8 px-4 md:flex-row md:items-start md:justify-between md:px-8">
        ...
        <div className="max-w-xl md:space-y-8 space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 uppercase">
            <Badge text="Instant PDF Access" />
            <Badge text="Executive Built" />
          </div>
        </div>
            ...
            <div className="space-y-6 px-4 py-6 md:px-6 md:py-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="btn_primary_for_insurance !font-[800] md:!text-[18px] !text-[16px] !tracking-[1px] mt-2 flex w-full items-center uppercase justify-center gap-2 !py-2 !rounded-[8px] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] group"
                >
                  <span>
                ...
                <div className="flex items-center justify-center gap-2 pt-1 md:text-[14px] text-[12px] font-[600] leading-[16px] text-[#3369B3] italic transition-all duration-300 group">
                  {/* <Lock
                    className="h-3.5 w-3.5 transition-transform duration-300 group-hover:scale-110"
                    aria-hidden
                  /> */}
                  <span className="transition-colors duration-300">
                    No hype. No vendor pitches. Just clarity.
                  </span>
                </div>
              </form>
            </div>
