          ...
          <div className="mt-4 w-full rounded-[16px] border border-white/10 bg-white/5 px-5 py-6 backdrop-blur-sm">
            <ul className="space-y-4">
              {bullets.map((item) => (
                ...
                >
                  <span className="flex h-6 w-6 group cursor-default items-center justify-center rounded-full bg-[#ef4444]/10 text-[#f97373]">
                    <XCircle
                      className="h-full w-full transition-transform duration-300 group-hover:scale-110"
                      aria-hidden
                    />
                  </span>
                  <span className="text-[16px] w-[240px] md:w-full font-bold leading-[24px] text-[#EEF1F8]">
                    {item}
                  </span>
                </li>
              ))}
