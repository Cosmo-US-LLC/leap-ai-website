    ...
    <section className="bg-white py-16">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-10 px-4 md:px-8">
        <div className="text-center">
          ...
          <p className="mt-3 text-[20px] font-[500] leading-[28px] text-[#475569] md:text-[18px] md:leading-[28px] transition-colors duration-300">
...
function FrameworkCard({ number, icon: Icon, title, description }) {
  return (
    <div className="relative rounded-[32px] border border-[#e2e8f0] bg-[#f8fafc] p-10 transition-all duration-300 hover:scale-[1.02] hover:bg-white hover:border-[#cbd5e1] hover:shadow-[0_20px_25px_-5px_rgba(226,232,240,0.5),0_8px_10px_-6px_rgba(226,232,240,0.5)] group cursor-default">
      ...
      <div className="relative z-10">
        <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl border border-[#f1f5f9] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.05)] transition-all duration-300 group-hover:scale-110 group-hover:bg-[#3e6db5] group-hover:shadow-[0_4px_6px_rgba(0,0,0,0.1)]">
          <Icon className="h-8 w-8 text-[#3e6db5] transition-all duration-300 group-hover:text-white group-hover:rotate-3" aria-hidden />
        </div>
