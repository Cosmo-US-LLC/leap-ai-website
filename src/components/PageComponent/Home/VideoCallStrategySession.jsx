      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-10 px-4 md:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="rounded-[30px] border border-[#f1f5f9] bg-white p-8 shadow-[0_20px_25px_-5px_rgba(226,232,240,0.5),0_8px_10px_-6px_rgba(226,232,240,0.5)]">
            ...
            <h3 className="mt-6 text-[24px] font-extrabold leading-[28px] text-[#2b2b76]">
              What We Will Do
            </h3>
            <ul className="mt-6 space-y-4 text-left">
              <li className="flex gap-3">
                <span className="mt-[6px] inline-flex h-6 w-6 items-center justify-center rounded-full bg-[rgba(62,109,181,0.2)] text-[#3e6db5]">
                ...
                <div>
                  ...
                  <p className="text-[14px] leading-[20px] text-[#475569]">
                    We explain why 95% of AI projects fail so you can avoid them.
                  </p>
                </div>
              </li>
              <li className="flex gap-3">
          ...
          <div className="relative overflow-hidden rounded-[30px] bg-[#2b2b76] p-8 text-white shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)]">
            ...
            <div className="relative">
              ...
              <ul className="mt-6 space-y-4 text-left">
                <li className="flex gap-3">
                  <span className="mt-[6px] inline-flex h-6 w-6 items-center justify-center rounded-full bg-[#059669]">
                    <Check className="h-3.5 w-3.5" aria-hidden />
                  </span>
                  <p className="text-[16px] font-bold leading-[24px] text-[rgba(255,255,255,0.9)]">
              ...
              <div className="mt-8 border-t border-[rgba(255,255,255,0.1)] pt-6">
                <div className="flex items-center gap-3 rounded-[12px] bg-[rgba(5,150,105,0.1)] px-4 py-2">
                  <div className="flex h-4 w-4 items-center justify-center text-[#059669]">
                    <div className="h-3 w-3 rounded-full border border-[#059669]" />
                  </div>
                  <p className="text-[14px] font-bold leading-[20px] text-[#059669]">
                    CURRENT AVAILABILITY
                  </p>
                </div>
                <p className="mt-3 text-[14px] leading-[20px] text-[#cbd5e1]">
