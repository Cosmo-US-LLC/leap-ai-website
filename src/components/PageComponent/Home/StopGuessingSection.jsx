  ...
  return (
    <section className="bg-white py-16">
      <div className="mx-auto w-full max-w-[1280px] px-4 md:px-8">
        <div className="relative overflow-hidden rounded-[40px] bg-[#2b2b76] px-8 py-10 text-white shadow-[0_25px_50px_-12px_rgba(15,23,42,0.6)] md:px-12 md:py-14">
          {/* gradient blobs */}
          ...
          <div className="relative flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
            ...
            <div className="max-w-xl space-y-6">
              <h2 className="text-[32px] font-[800] leading-[40px] md:text-[44px] md:leading-[48px]">
                <span className="block">Stop Guessing.</span>
                <span className="block">Start Implementing</span>
              </h2>
              <p className="text-[16px] font-[500] leading-[24px] text-[#e2e8f0] md:text-[18px] md:leading-[28px]">
              ...
              <ul className="space-y-3">
                {bullets.map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[rgba(5,150,105,0.2)]">
            ...
            <div className="relative mt-4 flex justify-center md:mt-0 md:justify-end">
              <div className="h-[320px] w-full max-w-[420px] rotate-3 rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[rgba(15,23,42,0.3)] p-6 backdrop-blur-md">
                {/* Before card */}
                <div className="mb-10 rounded-xl border border-[rgba(255,255,255,0.05)] bg-[rgba(15,23,42,0.3)] px-4 py-3">
                  <div className="mb-1 flex items-center gap-2">
                    ...
                    <p className="text-[14px] font-[700] leading-[20px] text-white">
                ...
                <div className="mb-8 flex items-center justify-center">
                  <div className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[rgba(148,163,184,0.5)] text-[#cbd5e1]">
                    <ArrowRight className="h-4 w-4" aria-hidden />
                  </div>
                </div>

                {/* After card */}
                <div className="rounded-xl border border-[rgba(34,197,94,0.4)] bg-[rgba(16,185,129,0.25)] px-4 py-3">
                  <div className="mb-1 flex items-center gap-2">
