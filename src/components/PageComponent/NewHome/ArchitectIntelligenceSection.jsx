...
export default function ArchitectIntelligenceSection() {
  ...
  const stats = useMemo(() => t("architect.stats", { returnObjects: true, ns: "home" }), [t]);
        ...
        <div className="relative mx-auto grid max-w-[1168px] gap-8 max-lg:gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="text-center max-lg:items-center lg:text-left">
            <h2 className="nh-architect-heading">
              <span className="nh-architect-heading-bold">{t("architect.headingBold", { ns: "home" })}</span>
              <span className="nh-architect-heading-muted">{t("architect.headingMuted", { ns: "home" })}</span>
            </h2>
            <p className="nh-body-dark mt-4 max-lg:mt-4 lg:mt-6">{t("architect.body", { ns: "home" })}</p>
