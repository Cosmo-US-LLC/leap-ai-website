...
export function BookYourConsultation() {
  const handleBookConsultation = () => {
    ...
    window.open('https://link.leap41.ca/widget/bookings/leap-ai-free-strategy-consultation','_self');
  };
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-128px-67px)] w-full max-w-[1280px] flex-col items-center justify-center px-4 py-12 md:px-8">
        <div className="relative z-10 flex w-full max-w-[576px] flex-col items-center">
          ...
          <button
            ...
            className="mb-6 flex h-[60px] btn_primary hover:cursor-pointer w-full max-w-[365px] items-center justify-center gap-3 rounded-[9999px] bg-[#3e6db5] px-6 ! md:text-[18px] font-[800] leading-[28px] text-white shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] transition-colors hover:bg-[#2d5a9d] md:mb-8"
          >
