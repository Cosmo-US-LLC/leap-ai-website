...
const en = {
  hero: {
    title: "Stop guessing.",
    titleAccent: "Start leading.",
    body: "Most companies are buying AI tools and hoping for the best. That's not a strategy, it's a gamble. We built a proven framework that turns AI from an expensive experiment into your greatest competitive advantage.",
    downloadReport: "Download report",
    imageAlt: "Team collaborating on AI strategy",
  },
  challenge: {
    headingBold: "AI isn't a technology challenge. ",
    headingMuted: "It's a leadership challenge.",
    body: [
      "Most AI initiatives fail , not because the technology doesn't work, but because companies skip the foundations. They buy tools before they've aligned their teams. They automate processes before they've cleaned their data. They chase trends before they've defined their strategy.",
      "The result? Wasted budgets, frustrated teams, and a growing gap between you and the competitors who got it right.",
    ],
    cardHeading:
      "Companies that wait won't just miss out , they'll pay a premium to catch up.",
    stats: [
      {
        value: "87%",
    ...
    callout: "Lack of organizational readiness, not the technology itself.",
  },
  pillars: {
    headingBold: "The 7 ",
    headingMuted: "Strategic Pillars",
    intro:
      "If the problem is organizational readiness, the solution isn't more tools , it's a complete framework. These seven pillars address every dimension of AI transformation: your people, your data, your strategy, and the governance to tie it all together.",
    navAria: "Strategic pillars",
    progress: "{{current}} of 7",
    talkToExpert: "Talk to an expert about this pillar",
  ...
  value: {
    headingBold: "We don't sell software. ",
    headingMuted: "We build market leaders.",
    intro:
      "Knowing the pillars is one thing. Executing them inside your organization , with your people, your constraints, your market , is another. That's where we come in.",
    cards: [
      {
        title: "A Real Roadmap, Not a Sales Pitch",
        description:
          "You get a 100+ page strategic plan with 15–20 specific AI projects, sequenced by priority, each tied to measurable KPIs and validated ROI. Not theory , an execution blueprint.",
      },
      {
        title: "People First, Technology Second",
        description:
          "95% of AI projects fail because they ignore the human side. Our framework starts with your workforce, your culture, and your workflows , the foundation that makes everything else work.",
      },
      {
        title: "Revenue Decoupled from Headcount",
        description:
          "Stop scaling costs at the same rate as revenue. Our methodology redesigns how your company functions so you can grow without proportionally growing your team or eroding your margins.",
      },
    ],
  },
  trustReport: {
    titleBold: "This Page Covers the Principles. ",
    titleMuted: "The Report Goes Deeper.",
    description:
      "Each pillar includes 3–4 detailed strategic actions, real-world implementation guidance, and a step-by-step methodology you can start executing tomorrow. Plus ROI stress-testing frameworks to keep your plan bankable.",
    photoAlt: "Team collaborating on AI strategy",
    downloadFullReport: "Download the Full Report",
  },
  roadmap: {
    headingBold: "How we build your ",
    headingMuted: "AI roadmap",
    intro:
      "Principles are clean, but your business is messy. You can't copy-paste a generic strategy. Here's the methodology we use to translate these pillars into a plan that fits your reality, your constraints, and your ambition.",
  ...
  authors: {
    headingBold: "About ",
    headingMuted: "Authors",
    intro:
      "This framework was built by practitioners, not theorists. As former executives, we don't just advise , we've sat in your seat.",
    prev: "Previous author",
    next: "Next author",
    viewAuthor: "View {{name}}",
    items: [
      {
    ...
    cta: {
      headingBold: "Want ",
      headingMuted: "the complete framework?",
      body: "The full report includes detailed strategic actions for every pillar, the complete 5-step implementation methodology, ROI stress-testing frameworks, and a roadmap for building your AI-enhanced organization.",
      downloadReport: "Download the 7 Pillars Report",
    },
  },
  trust: {
    defaultTitleBold: "A partner you ",
    defaultTitleMuted: "can trust.",
    defaultDescription:
    ...
    defaultPhotoAlt: "Leap 41 team collaborating around a table",
    bookConsultation: "Book a Free Consultation Call",
  },
};

// English only — fr/es methodology.json are maintained directly in src/locales/
// with full translations (do not regenerate from partial overrides here).
fs.writeFileSync(
  path.join(root, "src/locales/en/methodology.json"),
  `${JSON.stringify(en, null, 2)}\n`,
);

console.log("Wrote src/locales/en/methodology.json (fr/es unchanged)");
